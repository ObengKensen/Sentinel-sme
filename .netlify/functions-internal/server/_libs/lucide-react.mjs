...
const FileChartColumn = createLucideIcon("file-chart-column", __iconNode$k);
const __iconNode$j = [
  [
    "path",
    {
...
const FileCheckCorner = createLucideIcon("file-check-corner", __iconNode$j);
const __iconNode$i = [
  [
    "path",
    {
