...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D0mJFKkV.mjs");
...
const manifest = {
  "06de1968dc1a0e125ee62ba6428556b0a9554d4fbccdf60324f60f63b6756b07": {
    functionName: "loginAccountFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "1ab810b15808738ba3b6d08f809f56a547ab4585c80649081b08fca4df9b2b6d": {
    functionName: "loadAllSmeRiskStatesFn_createServerFn_handler",
    importer: () => import("./risk-data.functions-CWzSG9K7.mjs")
  },
  "2cc65e98fefcdd3523289cc8a671abdf44e90f757943b5409842ee4a91125820": {
    functionName: "verifyAuthTokenFn_createServerFn_handler",
    importer: () => import("./auth.functions-DDMtrpOd.mjs")
  },
  "4a36f2d1bfd66242a88264b4575b60e5bfc3560f46d9e20607f2eb7b7d74c30a": {
    functionName: "registerAccountFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "5f4c63a8e6da6620b2acc63d751b16b25799520269b5a383e39974269a22d9ea": {
    functionName: "getAuthBackendStatusFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "6ad6e3b3d756b1c8368ac45cc64fba9b34d6b7055bfc1520544fb082bafd1d64": {
    functionName: "sendAlertEmailFn_createServerFn_handler",
    importer: () => import("./alert-email.functions-CTIFKP0t.mjs")
  },
  "8fa0e13e4a07249306929f9e1dca61bd78057527aae39fb142b159cc1a5aceb8": {
    functionName: "saveRiskStateFn_createServerFn_handler",
    importer: () => import("./risk-data.functions-CWzSG9K7.mjs")
  },
  "92ba317f8c696bd3af31aa139ed9c1f6740732c08f6c083c502d2813c9dfeaa0": {
    functionName: "issueAuthTokenFn_createServerFn_handler",
    importer: () => import("./auth.functions-DDMtrpOd.mjs")
  },
  "9591f62ae6ff24aeef9b8412d8074a07565301e7c55713f02cc769a6d19a3da7": {
    functionName: "updateAccountStatusFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "95ea42531ae72f0a74f8253be52252bc00022e1996017828d7cdd7512efa2eb8": {
    functionName: "updateAccountEmailFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "ab86894539af2179a85590228fde8468173a76344cb30a56302e203c77b25318": {
    functionName: "loadRiskStateFn_createServerFn_handler",
    importer: () => import("./risk-data.functions-CWzSG9K7.mjs")
  },
  "ae4d836b75db405fa7e212e24f298bedc15be81b0069838a96cb62ecc8853bc2": {
    functionName: "getAccountByIdFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "bb59c875dd92178bbe25ad83a00d2e5dbe184c16c843f13754a8f8b001988b62": {
    functionName: "resetAccountPasswordFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "c5b08e312a37de18e53540c3a57745e2cd2e614ca3e31a10e103a0d1ff0a920b": {
    functionName: "checkEmailAvailableFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "ca5596057431a8fb0ec5416c9c95bf3e1a9e41a38fd46323e50fdb772cb7a6c1": {
    functionName: "listAccountsFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "cb0be79324c6744b939c899ad9fd32dcd83eab44bac828ca7c406f10d642fbc6": {
    functionName: "seedSuperAdminAccountFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  },
  "d2907f0502872a9f5b8fd67efb414e58cb9ff6406c29750d5b6d32213f069e6c": {
    functionName: "changeAccountPasswordFn_createServerFn_handler",
    importer: () => import("./account.functions-KOq5rMPo.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BdVNv3tq.mjs").then((n) => n.router),
    import("./start-CIq48u2a.mjs"),
