...
const SidebarProvider = reactExports.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { delayDuration: 0, disableHoverableContent: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              className: cn(
                "relative w-(--sidebar-width) shrink-0 bg-transparent transition-[width] duration-200 ease-out",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              className: cn(
                "fixed inset-y-0 z-10 hidden h-svh overflow-hidden transition-[width] duration-200 ease-out md:flex",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  "data-sidebar": "sidebar",
                  className: cn(
                    "flex h-full w-(--sidebar-width) flex-col bg-sidebar transition-transform duration-200 ease-out",
                    side === "left" ? "group-data-[collapsible=offcanvas]:-translate-x-full" : "group-data-[collapsible=offcanvas]:translate-x-full",
  ...
  ({ className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-[transform,opacity] duration-200 ease-out after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
...
const SidebarGroupLabel = reactExports.forwardRef(({ className, asChild = false, ...props }, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Comp,
    {
      ...
      className: cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-sm font-semibold text-sidebar-foreground/80 outline-none ring-sidebar-ring transition-[transform,opacity] duration-200 ease-out focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "group-data-[collapsible=icon]:pointer-events-none group-data-[collapsible=icon]:-translate-x-2 group-data-[collapsible=icon]:opacity-0",
        className
      ),
      ...props
    }
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring cursor-pointer transition-[background-color,box-shadow,color] duration-200 ease-out hover:data-[active=false]:bg-white/10 hover:data-[active=false]:text-sidebar-foreground focus-visible:ring-2 active:data-[active=false]:bg-white/10 active:data-[active=false]:text-sidebar-foreground disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[active=true]:hover:bg-sidebar-accent data-[active=true]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>span:last-child]:transition-[transform,opacity] [&>span:last-child]:duration-200 [&>span:last-child]:ease-out [&>span:last-child]:group-data-[collapsible=icon]:pointer-events-none [&>span:last-child]:group-data-[collapsible=icon]:-translate-x-1 [&>span:last-child]:group-data-[collapsible=icon]:opacity-0 [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "",
        outline: "bg-background shadow-[0_0_0_1px_var(--sidebar-border)] hover:data-[active=false]:shadow-[0_0_0_1px_var(--sidebar-accent)]"
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-sm",
...
const SidebarMenuButton = reactExports.forwardRef(
  ({
    ...
    const button = /* @__PURE__ */ jsxRuntimeExports.jsx(
      Comp,
      {
        ...
        onPointerLeave: (event) => {
          ...
          if (target instanceof HTMLElement && target.matches(":focus:not(:focus-visible)")) {
            target.blur();
          }
        },
        ...props
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", align: "center", ...tooltip })
    ] });
  }
);
...
export {
  ...
  SidebarContent as e,
  SidebarGroup as f,
  SidebarGroupLabel as g,
  SidebarGroupContent as h,
  SidebarMenu as i,
  SidebarMenuItem as j,
  SidebarMenuButton as k,
  SidebarFooter as l
};
