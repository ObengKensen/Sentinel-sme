...
import { CSRF_META_NAME, getCsrfToken } from "../lib/csrf";
import { reportError } from "../lib/error-reporting";
import { exposeResetOnWindow } from "../lib/reset-app-data";
...
function RootShell({ children }: { children: ReactNode }) {
  ...
  return (
    <html lang="en">
      <head>
        <HeadContent />
        {csrfToken ? <meta name={CSRF_META_NAME} content={csrfToken} /> : null}
      </head>
      <body>
        {children}
        <Scripts />
